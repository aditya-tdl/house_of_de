      ...
      <div className="container mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-sm opacity-60 leading-relaxed">
              Crafting the perfect white shirt for the discerning gentleman since 1990.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <a href="tel:+918618495944" className="flex items-center gap-2 text-sm opacity-60 hover:opacity-100 transition-opacity">
                <Phone size={14} />
                +91 8618495944
              </a>
              <div className="flex items-start gap-2 text-sm opacity-60">
                <MapPin size={14} className="mt-1 flex-shrink-0" />
                <span>No.15/1, 18th Cross,Malleshwaram,
                  Bangalore  560055
                </span>
              </div>
            </div>
        ...
        <div className="mt-16 pt-8 border-t border-background/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs opacity-40">
            © 2026 House of De. All rights reserved.
          </p>
          <div className="flex gap-8">
            <Link
              to="/privacy-policy"
              className="text-sm font-serif tracking-wide opacity-60 hover:opacity-100 transition-all duration-300 border-b border-transparent hover:border-background/60 pb-0.5"
            >
              Privacy Policy
            </Link>
            <Link
